...
from simulation.autopilot import FlightplanAutopilot, CoefAutopilot
...
controller = CoefAutopilot(trimmed_controls)
controller.target = Target(pos=[6000.0, 10.0, -6100.0], velocity=(0.0, 5.0, 0.0))

sim = TakeoffSim(aircraft, system, environment, controller, dt=0.01)

res_df = sim.propagate(90.0)
